    ...
    <div class="w-100% flex justify-center h-screen">
        ...
        <div class="w-1/2 flex justify-center flex-col items-center h-full">
            <div class="flex flex-col items-center w-[600px]">
                ...
                <div class="my-2">
                    <input class="w-[400px] bg-[#050505] outline-none border p-2 px-4 rounded-xl text-gray-100" type="text"
                ...
                <div class="my-2">
                    ...
                    <div class="w-[400px] flex" x-data="{
                        ...
                        <input class="w-[350px] outline-none bg-[#050505] p-2 px-4 rounded-s-xl text-gray-100"
                            :type='type' id="password" placeholder="Masukan Password">

                        {{-- toggle password visible --}}
                        <div class="w-[50px] bg-[#050505] flex justify-center items-center rounded-e-xl "
                            x-on:click="toggle">
                            {{-- icon eye --}}
                            ...
                            {{-- icon eye slash --}}
                            <svg x-cloak x-show="!visible" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                class="bi bi-eye-slash fill-white" viewBox="0 0 16 16">
                                <path
                ...
                <div class="my-2">
                    <button class="w-[400px] bg-[#94C0AC] p-2 text-white rounded-md">Masuk</button>
                </div>
